...
Add "Age-graded time" functionality

- Add class "AgeGrade"
  - constructor with two Age objects
  - with 'predict' method, passing the name of the formula (default to 'maxpulse')

- Refactor class Age as necessary
  - max_pulse method??

- Update specs, ensure 100% coverage.

- Note: this enhancement ports similar logic from my RunToolz iOS app.
