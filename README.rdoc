...
version 0.4.0, released 2013-10-31
...
== Synopsis
  ...
  # Ultramarathon calculations - run and walk and rest/stopped segments
    ...
    u.moving_speed   # A M26::Speed object is returned reflecting the run & walk
    u.overall_speed  # A M26::Speed object is returned reflecting the run & walk & rest
